User Authentication: Users can register and log in, with their credentials being validated and stored in MongoDB. Upon successful login, users are redirected to the "Add Recipe" page.
